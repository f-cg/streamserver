...
public class KafkaConnectorConsumerTableSQLWindowApp {
	...
	public static void main(String[] args) throws Exception {
		...
		String ddl = "CREATE TABLE MykfkSource(\n" +
		...
		Table MykfkSource = tEnv.from("MykfkSource");
		MykfkSource.printSchema();
		String query = "SELECT\n" +
		...
		/*
		 * query =
		 * "select DATE_FORMAT(ts, 'yyyy-MM-dd HH:00') dt, COUNT(*) AS cnt from MykfkSource GROUP BY DATE_FORMAT(ts, 'yyyy-MM-dd HH:00')"
		 * ;
		 */
