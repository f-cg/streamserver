 ...
 */
@Internal
public abstract class MyCsvTableSourceFactory implements TableFactory {

	@Override
	public Map<String, String> requiredContext() {
		Map<String, String> context = new HashMap<>();
		context.put(CONNECTOR_TYPE, CONNECTOR_TYPE_VALUE);
		context.put(FORMAT_TYPE, "csv2");
	...
	protected MyCsvTableSource createTableSource(
			Boolean isStreaming,
		...
		// build
		MyCsvTableSource.Builder csvTableSourceBuilder = new MyCsvTableSource.Builder();
